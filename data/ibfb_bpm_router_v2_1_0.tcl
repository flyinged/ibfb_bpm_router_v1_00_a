...
proc generate_corelevel_ucf {mhsinst} {
    ...
    #BPM01
    puts $outputFile "  NET \"${instname}/*mgt_o_rx<0>_RXRECCLK\"  TNM_NET = RXCLK0;"
    puts $outputFile "  NET \"${instname}/*mgt_o_rx<1>_RXRECCLK\"  TNM_NET = RXCLK1;"
    puts $outputFile "  NET \"${instname}/*mgt_out_tx<0>_TXOUTCLK\"  TNM_NET = TXCLK0;"
    puts $outputFile "  NET \"${instname}/*mgt_out_tx<1>_TXOUTCLK\"  TNM_NET = TXCLK1;"
    ...
    puts $outputFile "  TIMESPEC TS_RXCLK0 = PERIOD \"RXCLK0\" 6.4 ns HIGH 50%;"
    puts $outputFile "  TIMESPEC TS_RXCLK1 = PERIOD \"RXCLK1\" 6.4 ns HIGH 50%;"
    puts $outputFile "  TIMESPEC TS_TXCLK0 = PERIOD \"TXCLK0\" 6.4 ns HIGH 50%;"
    puts $outputFile "  TIMESPEC TS_TXCLK1 = PERIOD \"TXCLK1\" 6.4 ns HIGH 50%;"
    #BPM01
