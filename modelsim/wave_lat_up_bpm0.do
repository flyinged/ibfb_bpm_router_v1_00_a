...
add wave -noupdate -expand -group {LATENCY UP 0} /ibfb_packet_router_tb/BPM0_EMU/adc_x_valid
add wave -noupdate -expand -group {LATENCY UP 0} /ibfb_packet_router_tb/BPM0_EMU/rout_in_valid(0)
add wave -noupdate -expand -group {LATENCY UP 0} /ibfb_packet_router_tb/BPM0_EMU/rout_out_valid(1)
add wave -noupdate -expand -group {LATENCY UP 0} -color magenta /ibfb_packet_router_tb/bp_txf_next(0)
add wave -noupdate -expand -group {LATENCY UP 0} /ibfb_packet_router_tb/us_rxf_wr
add wave -noupdate -expand -group {LATENCY UP 0} /ibfb_packet_router_tb/us_rxf_next
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {SRC_DATA_VALID {11003125 ps} 1} {{Cursor 2} {11142500 ps} 1} {{Cursor 3} {11219200 ps} 1} {{Cursor 4} {11283300 ps} 1} {{Cursor 15} {11483300 ps} 1} {{Cursor 16} {11539300 ps} 1}
...
update
WaveRestoreZoom {10917159 ps} {11668883 ps}
