...
add wave -noupdate -expand -group {LATENCY DOWN 1} /ibfb_packet_router_tb/BPM1_EMU/adc_x_new
add wave -noupdate -expand -group {LATENCY DOWN 1} /ibfb_packet_router_tb/BPM1_EMU/rout_in_valid(0)
add wave -noupdate -expand -group {LATENCY DOWN 1} /ibfb_packet_router_tb/BPM1_EMU/rout_out_valid(1)
add wave -noupdate -expand -group {LATENCY DOWN 1} -color magenta /ibfb_packet_router_tb/bp_txf_next(1)
add wave -noupdate -expand -group {LATENCY DOWN 1} -color magenta /ibfb_packet_router_tb/bp_rxf_wr(3)
add wave -noupdate -expand -group {LATENCY DOWN 1} /ibfb_packet_router_tb/BPM3_EMU/rout_in_valid(2)
add wave -noupdate -expand -group {LATENCY DOWN 1} /ibfb_packet_router_tb/BPM3_EMU/rout_out_valid(1)
add wave -noupdate -expand -group {LATENCY DOWN 1} -color magenta /ibfb_packet_router_tb/bp_txf_next(3)
add wave -noupdate -expand -group {LATENCY DOWN 1} /ibfb_packet_router_tb/ds_rxf_wr
add wave -noupdate -expand -group {LATENCY DOWN 1} /ibfb_packet_router_tb/ds_rxf_next
...
WaveRestoreCursors {SRC_DATA_VALID {11003125 ps} 1} {{Cursor 17} {11142500 ps} 1} {{Cursor 3} {11219200 ps} 1} {{Cursor 4} {11283300 ps} 1} {{Cursor 5} {11483300 ps} 1} {{Cursor 6} {11539300 ps} 1} {{Cursor 7} {11628800 ps} 1} {{Cursor 8} {11692900 ps} 1} {{Cursor 9} {11892900 ps} 1} {{Cursor 10} {11948900 ps} 1}
