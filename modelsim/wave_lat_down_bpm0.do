...
add wave -noupdate -group Router0 /ibfb_packet_router_tb/BPM0_EMU/rout_out_valid
...
add wave -noupdate -group Router1 /ibfb_packet_router_tb/BPM1_EMU/rout_out_valid
add wave -noupdate -expand -group Router3 /ibfb_packet_router_tb/BPM3_EMU/rout_in_charisk
add wave -noupdate -expand -group Router3 /ibfb_packet_router_tb/BPM3_EMU/rout_in_data
add wave -noupdate -expand -group Router3 /ibfb_packet_router_tb/BPM3_EMU/rout_in_next
add wave -noupdate -expand -group Router3 /ibfb_packet_router_tb/BPM3_EMU/rout_in_valid
add wave -noupdate -expand -group Router3 /ibfb_packet_router_tb/BPM3_EMU/rout_out_charisk
add wave -noupdate -expand -group Router3 /ibfb_packet_router_tb/BPM3_EMU/rout_out_data
add wave -noupdate -expand -group Router3 /ibfb_packet_router_tb/BPM3_EMU/rout_out_err
add wave -noupdate -expand -group Router3 /ibfb_packet_router_tb/BPM3_EMU/rout_out_next
add wave -noupdate -expand -group Router3 -expand /ibfb_packet_router_tb/BPM3_EMU/rout_out_valid
add wave -noupdate -group {XF TX} -color cyan /ibfb_packet_router_tb/xf_txf_empty
add wave -noupdate -group {XF TX} -color magenta /ibfb_packet_router_tb/xf_txf_next
...
add wave -noupdate -expand -group {BP TX} -color cyan /ibfb_packet_router_tb/bp_txf_empty
add wave -noupdate -expand -group {BP TX} -color magenta -expand -subitemconfig {/ibfb_packet_router_tb/bp_txf_next(0) {-color magenta} /ibfb_packet_router_tb/bp_txf_next(1) {-color magenta} /ibfb_packet_router_tb/bp_txf_next(2) {-color magenta} /ibfb_packet_router_tb/bp_txf_next(3) {-color magenta}} /ibfb_packet_router_tb/bp_txf_next
add wave -noupdate -expand -group {BP TX} /ibfb_packet_router_tb/bp_txf_isk
add wave -noupdate -expand -group {BP TX} /ibfb_packet_router_tb/bp_txf_data
add wave -noupdate -group {XF RX} -color cyan /ibfb_packet_router_tb/xf_rxf_full
add wave -noupdate -group {XF RX} -color magenta /ibfb_packet_router_tb/xf_rxf_wr
...
add wave -noupdate -expand -group {DS RX FIFO} /ibfb_packet_router_tb/ds_rxf_empty
add wave -noupdate -expand -group {DS RX FIFO} /ibfb_packet_router_tb/ds_rxf_full
add wave -noupdate -expand -group {DS RX FIFO} /ibfb_packet_router_tb/ds_rxf_next
add wave -noupdate -expand -group {DS RX FIFO} /ibfb_packet_router_tb/ds_rxf_rdata
add wave -noupdate -expand -group {DS RX FIFO} /ibfb_packet_router_tb/ds_rxf_risk
add wave -noupdate -expand -group {DS RX FIFO} /ibfb_packet_router_tb/ds_rxf_wdata
add wave -noupdate -expand -group {DS RX FIFO} /ibfb_packet_router_tb/ds_rxf_wisk
add wave -noupdate -expand -group {DS RX FIFO} /ibfb_packet_router_tb/ds_rxf_wr
...
add wave -noupdate -expand -group LATENCY /ibfb_packet_router_tb/BPM0_EMU/adc_x_valid
add wave -noupdate -expand -group LATENCY /ibfb_packet_router_tb/BPM0_EMU/rout_in_valid(0)
add wave -noupdate -expand -group LATENCY /ibfb_packet_router_tb/BPM0_EMU/rout_out_valid(0)
add wave -noupdate -expand -group LATENCY -color magenta /ibfb_packet_router_tb/xf_txf_next(0)
add wave -noupdate -expand -group LATENCY -color magenta /ibfb_packet_router_tb/xf_rxf_wr(1)
add wave -noupdate -expand -group LATENCY /ibfb_packet_router_tb/BPM1_EMU/rout_in_next(1)
add wave -noupdate -expand -group LATENCY /ibfb_packet_router_tb/BPM1_EMU/rout_out_valid(1)
add wave -noupdate -expand -group LATENCY -color magenta /ibfb_packet_router_tb/bp_txf_next(1)
add wave -noupdate -expand -group LATENCY -color magenta /ibfb_packet_router_tb/bp_rxf_wr(3)
add wave -noupdate -expand -group LATENCY /ibfb_packet_router_tb/BPM3_EMU/rout_in_valid(2)
add wave -noupdate -expand -group LATENCY /ibfb_packet_router_tb/BPM3_EMU/rout_out_valid(1)
add wave -noupdate -expand -group LATENCY -color magenta /ibfb_packet_router_tb/bp_txf_next(3)
add wave -noupdate -expand -group LATENCY /ibfb_packet_router_tb/ds_rxf_wr
add wave -noupdate -expand -group LATENCY /ibfb_packet_router_tb/ds_rxf_valid
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {SRC_DATA_VALID {11003125 ps} 1} {{Cursor 2} {11142500 ps} 1} {{Cursor 3} {11219200 ps} 1} {{Cursor 4} {11283300 ps} 1} {{Cursor 5} {11483300 ps} 1} {{Cursor 6} {11539300 ps} 1} {{Cursor 7} {11616000 ps} 1} {{Cursor 8} {11680100 ps} 1} {{Cursor 9} {11880100 ps} 1} {{Cursor 10} {11936100 ps} 1} {{Cursor 11} {12012800 ps} 1} {{Cursor 12} {12076900 ps} 1} {{Cursor 13} {12276900 ps} 1} {{Cursor 14} {12332900 ps} 1}
quietly wave cursor active 14
...
update
WaveRestoreZoom {11148446 ps} {12501291 ps}
